...
for (var i = 0; i < guardaN2.length; i++) {
    if (guardaN1.includes(guardaN2[i]) == false) { 
        numDiferentes.push(guardaN2[i])
     }
}

for (var i = 0; i < guardaN1.length; i++) {
    if (guardaN2.includes(guardaN1[i]) == true) { 
        numDiferentes.push(guardaN1[i])
     }
}


console.log(`Os números digitados de ambos jogadores são: ${numDiferentes.sort()}`)
