...
let header = rs.question('Digite os campos que você quer na tabela entre ponto e virgula (;) ').split(';')
let data = rs.question('Digite as informações correspondentes aos campos entre ponto e virgula (;) ').split(';')

// console.log(header, data)

if(header.length != data.length){
    console.log(`O formato dos dados não é compatível. Tente novamente. `)
    return
}
